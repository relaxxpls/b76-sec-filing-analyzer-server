...
# with open('revenue_10-K.json', 'w') as file:
#     json.dump(revenue, file)

# with open('marketing_10-K.json', 'w') as file:
#     json.dump(marketing, file)

# with open('earnings_per_share_10-K.json', 'w') as file:
#     json.dump(eps, file)

# with open('share_price.json', 'w') as file:
#     json.dump(sprice, file)

# with open('revenue_10-K.json', 'r') as file:
#     revenue = json.load(file)

# with open('marketing_10-K.json', 'r') as file:
#     marketing = json.load(file)

with open('earnings_per_share_10-K.json', 'r') as file:
    eps = json.load(file)
